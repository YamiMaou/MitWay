                                    ...
                                    <CardContent>
                                        ...
                                        <div key={`block-${ind}`} id={`data-form-${form.id ?? '1'}`} style={{
                                        ...
                                        }}>
                                            {
                                                ...
                                                form.fields.map((input, ind1) => {
                                                    if (input.type == "date") {
                                                        return <DateInput value={input.value ?? ""} helperText={input.helperText ?? ""} key={`input-${ind1}`} id={input.column} label={input.label} style={{ ...classes.m5}} onChange={(e) => mainChange(e, { handle: input.handle ?? undefined, json: form.json ?? undefined, validate: input.validate ?? undefined })} />
                                                    } else if (input.type == "select") {
                                                        return (<SelectInput value={input.value ?? undefined} helperText={input.helperText ?? ""} key={`input-${ind1}`} id={input.column} label={input.label} name={input.column} values={input.values} style={{ ...classes.m5}} onChange={(e) => mainChange(e, { handle: input.handle ?? undefined, json: form.json ?? undefined, validate: input.validate ?? undefined })} />)
                                                    } else if (input.type == "file") {
                                                        return (
                                                            <FileInput key={`input-${ind1}`}
                                                                style={{ ...classes.m5, fontSize: '.6em' }}
